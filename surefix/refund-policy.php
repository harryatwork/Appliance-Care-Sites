...
$pageDescription = 'Sure Fix\'s refund, cancellation and warranty policy for appliance repair bookings.';
...
<section class="pad-sm">
  <div class="container">
    <div class="legal-content glass reveal">
      ...
      <h2>1. Overview</h2>
      <p>This policy explains how Sure Fix Home Appliance Repair &amp; Services handles booking cancellations, visiting/inspection charges, refunds, and warranty claims. It should be read together with our Terms &amp; Conditions. A "refund" (return of money already paid) and a "warranty claim" (a request to fix or make good a covered issue) are handled differently, as explained below.</p>
      ...
      <p>If you cancel after the technician has been dispatched, or after the technician has arrived at your location, Sure Fix may charge the applicable visiting/cancellation charge, as this reflects time and resources already committed to your booking. This charge is not arbitrary or punitive — it reflects the visiting/inspection charge structure described in Section 5 below.</p>
      ...
      <p>Spare parts that have been specifically ordered for your appliance or already installed are generally non-refundable once ordered/fitted, except where the part is found to be defective, incorrect, or unsuitable due to an error on Sure Fix's part (see Section 11 below), or where applicable law otherwise entitles you to a remedy.</p>

      <h2>11. Defective or Incorrect Spare Parts</h2>
      <p>If a spare part supplied or installed by Sure Fix is found to be defective, incorrect, or unsuitable, please contact us at <?php echo SITE_EMAIL; ?>. We will inspect the issue and determine the appropriate remedy, which may include repair, replacement, or another appropriate resolution, depending on the circumstances.</p>
      ...
      <p>You may be eligible for a refund in situations such as: verified overpayment, duplicate payment, a booking cancelled within the free-cancellation window where payment was already collected, or a service that could not be delivered due to a failure on Sure Fix's part.</p>
      ...
      <p>Refunds are generally processed within 5–7 business days of approval. Please note that the actual time for the refunded amount to reflect in your account may vary depending on your bank or payment provider's own processing timelines, which are beyond Sure Fix's control.</p>

      <h2>17. Bank/Payment-Provider Delays</h2>
      <p>If a refund has not reflected in your account within a reasonable time after processing by Sure Fix, please contact us with your transaction details so we can help you follow up, including, where necessary, with the relevant bank or payment provider.</p>
      ...
      <p><strong>Sure Fix Home Appliance Repair &amp; Services</strong><br>
      Email: <?php echo SITE_EMAIL; ?><br>
      Phone: <?php echo SITE_PHONE; ?><br>
      Website: sure-fix.in</p>
    </div>
  </div>
</section>
