          ...
          <div class="hero__quick-form">
            ...
            <div class="hero__quick-form-body">
              <form id="quickEnquiryForm" novalidate>
                ...
                <p class="hero__quick-form-consent">By submitting, you consent to be contacted by Sure Fix and agree to our <a href="<?php echo SITE_URL; ?>/privacy-policy.php">Privacy Policy</a>.</p>
              </form>
