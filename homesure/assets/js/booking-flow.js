...
(function () {
  ...
  function mapUnavailable(reason) {
    if (window.console && console.warn) console.warn('Home Sure location lookup unavailable: ' + reason);
  ...
  function loadGeocoder() {
    ...
    geocoderLoaded = true;
    if (!window.HOMESURE_MAPS_KEY) { mapUnavailable('no API key configured'); return; }
    ...
    script.src = 'https://maps.googleapis.com/maps/api/js?key=' +
      encodeURIComponent(window.HOMESURE_MAPS_KEY) + '&libraries=places&callback=__initGeocoder';
    script.async = true;
  ...
  function confirmBooking() {
    ...
    var base = window.HOMESURE_SITE_URL || '';
