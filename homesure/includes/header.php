...
<script>window.HOMESURE_SITE_URL = <?php echo json_encode(SITE_URL); ?>;</script>
</head>
<body>

<div class="preloader" id="preloader">
  <div class="preloader__logo"><img src="<?php echo SITE_URL; ?>/assets/images/logo.png" alt="Home Sure"></div>
</div>
  ...
  <div class="container">
    <div class="navbar__inner glass">
      <a href="<?php echo SITE_URL; ?>/index.php" class="logo">
        <img src="<?php echo SITE_URL; ?>/assets/images/logo.png" alt="Home Sure" class="logo__icon">
        <span class="logo__text">Home Sure</span>
      </a>
      <ul class="nav-menu">
